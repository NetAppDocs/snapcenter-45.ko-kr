...
+
link:task_configure_gMSA_on_windows_server_2012_or_later_for_custom_applications.html["사용자 지정 응용 프로그램에 대해 Windows Server 2012 이상에서 그룹 관리 서비스 계정을 구성합니다"]
...
** SnapCenter 맞춤형 플러그인:
+
... 사용자 지정 플러그인 섹션에서 * 찾아보기 * 를 클릭한 다음 압축된 사용자 지정 플러그인 폴더를 선택합니다.
+
