...
* SnapCenter는 SnapCenter 소프트웨어 4.5 P1 패치 릴리즈부터 NetApp ONTAP용 Amazon FSx를 지원합니다.
+
NetApp ONTAP용 Amazon FSx를 사용하는 경우 데이터 보호 작업을 수행하려면 SnapCenter 서버 호스트 플러그인이 4.5 P1 패치 릴리즈로 업그레이드되었는지 확인하십시오.
...
+
지원되는 응용 프로그램 및 데이터베이스에 대한 자세한 내용은 을 참조하십시오 https://mysupport.netapp.com/matrix/imt.jsp?components=100747;&solution=1257&isHWU&src=IMT["NetApp 상호 운용성 매트릭스 툴"^].
